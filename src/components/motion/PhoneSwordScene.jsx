...
import { getPacketMotion, getPacketOrientation, getPacketTimestamp, hasUsableOrientationPacket } from './protocol';
...
const PhoneSwordScene = ({ packetRef, calibrateKey, onBlockScored }) => {
...
export default memo(PhoneSwordScene);
