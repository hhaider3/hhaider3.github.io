      ...
      <div className="container">
        ...
        <div className="about-bio-centered scroll-animate fade-in-up">
          <div className="about-bio-content">
            ...
            <p className="about-text">
              Recently, I have completed my M.S. in Software Engineering at Arizona State University with a specialization in Cybersecurity. My academic and project background spans various domains, including full-stack development, game engine scripting in Unity, hardware-software integration with IoT platforms, and utilizing state-of-the-art AI agents and LLMs. I am looking for job oppurtunities in Software Engineering and related roles.
            </p>
