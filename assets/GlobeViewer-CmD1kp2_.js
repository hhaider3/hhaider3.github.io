...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function bo(e,t,n){let r=new Float32Array(ao),i=new J(0,1,0);return new Wi({name:`SphericalGaussianBlur`,defines:{n:ao,CUBEUV_TEXEL_WIDTH:1/t,CUBEUV_TEXEL_HEIGHT:1/n,CUBEUV_MAX_MIP:`${e}.0`},uniforms:{envMap:{value:null},samples:{value:1},weights:{value:r},latitudinal:{value:!1},dTheta:{value:0},mipInt:{value:0},poleAxis:{value:i}},vertexShader:Co(),fragmentShader:`
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function xo(){return new Wi({name:`EquirectangularToCubeUV`,uniforms:{envMap:{value:null}},vertexShader:Co(),fragmentShader:`
	...
	`}var wo=class extends Ot{constructor(e=1,t={}){super(e,e,t),this.isWebGLCubeRenderTarget=!0;let n={width:e,height:e,depth:1},r=[n,n,n,n,n,n];this.texture=new Oi(r),this._setTextureOptions(t),this.texture.isRenderTargetTexture=!0}fromEquirectangularTexture(e,t){this.texture.type=t.type,this.texture.colorSpace=t.colorSpace,this.texture.generateMipmaps=t.generateMipmaps,this.texture.minFilter=t.minFilter,this.texture.magFilter=t.magFilter;let n={uniforms:{tEquirect:{value:null}},vertexShader:`
...
void main() {
	...
	if ( coord.x >= 1.0 ) {
      ...
      `}),(0,ll.jsx)(`div`,{style:{position:`absolute`,inset:`1px`,borderRadius:`inherit`,pointerEvents:`none`,boxShadow:`inset 0 0 0 1px rgba(255,255,255,0.28)`},"aria-hidden":`true`}),(0,ll.jsxs)(`div`,{style:{minHeight:`32px`,padding:`5px 6px 5px 10px`,display:`flex`,alignItems:`center`,justifyContent:`space-between`,color:`#0e2337`,textShadow:`0 1px 0 rgba(255,255,255,0.55)`,flexShrink:0},children:[(0,ll.jsxs)(`div`,{style:{display:`flex`,alignItems:`center`,gap:`6px`,fontSize:`12px`,fontWeight:700,minWidth:0,overflow:`hidden`},children:[(0,ll.jsx)(`span`,{style:{width:`18px`,height:`18px`,borderRadius:`4px`,flexShrink:0,background:`linear-gradient(135deg,#0ea5e9,#0284c7)`,display:`flex`,alignItems:`center`,justifyContent:`center`,color:`#fff`},children:(0,ll.jsxs)(`svg`,{width:`11`,height:`11`,viewBox:`0 0 24 24`,fill:`none`,stroke:`currentColor`,strokeWidth:`2.2`,strokeLinecap:`round`,strokeLinejoin:`round`,children:[(0,ll.jsx)(`circle`,{cx:`12`,cy:`12`,r:`10`}),(0,ll.jsx)(`line`,{x1:`2`,y1:`12`,x2:`22`,y2:`12`}),(0,ll.jsx)(`path`,{d:`M12 2a15.3 15.3 0 0 1 4 10 15.3 15.3 0 0 1-4 10A15.3 15.3 0 0 1 8 12a15.3 15.3 0 0 1 4-10z`})]})}),(0,ll.jsxs)(`span`,{style:{overflow:`hidden`,textOverflow:`ellipsis`,whiteSpace:`nowrap`},children:[a,o&&o!==a?` — ${o}`:``]})]}),(0,ll.jsx)(`button`,{className:`tz-close-btn`,onClick:t,style:{width:`40px`,height:`20px`,border:0,borderRadius:`0 0 4px 4px`,cursor:`pointer`,color:`#fff`,background:`linear-gradient(180deg,#e99b86,#c9452e 56%,#8b1e17)`,textShadow:`0 1px 1px rgba(0,0,0,0.45)`,display:`flex`,alignItems:`center`,justifyContent:`center`,fontSize:`13px`,lineHeight:1,flexShrink:0,pointerEvents:`auto`,boxShadow:`inset 0 1px 0 rgba(255,255,255,0.3)`,transition:`background 0.1s`},"aria-label":`Close timezone card`,children:`✕`})]}),(0,ll.jsxs)(`div`,{className:`tz-body`,style:{padding:`12px 18px 16px`,borderTop:`1px solid rgba(100,150,200,0.22)`,background:`transparent`},children:[(0,ll.jsx)(`div`,{className:`tz-meta`,style:{fontSize:`11px`,color:`rgba(30,60,100,0.5)`,marginBottom:`4px`,letterSpacing:`0.04em`},children:e}),(0,ll.jsx)(`div`,{className:`tz-time`,style:{fontSize:`40px`,fontWeight:200,letterSpacing:`-0.03em`,fontVariantNumeric:`tabular-nums`,color:`#0b3a5e`,lineHeight:1,marginBottom:`4px`},children:n.time}),(0,ll.jsxs)(`div`,{className:`tz-city`,style:{display:`flex`,alignItems:`baseline`,gap:`8px`,flexWrap:`wrap`},children:[(0,ll.jsx)(`span`,{style:{fontSize:`18px`,fontWeight:600,color:`#0e2a44`},children:n.date}),n.offset&&(0,ll.jsx)(`span`,{style:{fontSize:`12px`,color:`rgba(30,80,140,0.65)`,fontWeight:500},children:n.offset})]})]})]})},Il=()=>{let e=new Float32Array(ul*3),t=42,n=()=>(t=(t*1664525+1013904223)%4294967296,t/4294967296);for(let t=0;t<ul;t+=1){let r=48+n()*72,i=n()*Math.PI*2,a=Math.acos(n()*2-1),o=t*3;e[o]=r*Math.sin(a)*Math.cos(i),e[o+1]=r*Math.sin(a)*Math.sin(i),e[o+2]=r*Math.cos(a)}let r=new cr;return r.setAttribute(`position`,new qn(e,3)),new Ei(r,new xi({color:`#f8fafc`,size:.16,sizeAttenuation:!0,transparent:!0,opacity:.78}))},Ll=()=>{let e=document.createElement(`canvas`);e.width=256,e.height=256;let t=e.getContext(`2d`),n=t.createRadialGradient(128,128,0,128,128,128);n.addColorStop(0,`rgba(255, 248, 205, 0.92)`),n.addColorStop(.18,`rgba(255, 207, 92, 0.58)`),n.addColorStop(.52,`rgba(255, 128, 30, 0.2)`),n.addColorStop(1,`rgba(255, 128, 30, 0)`),t.fillStyle=n,t.fillRect(0,0,256,256);let r=new ki(e);return r.colorSpace=Le,r.needsUpdate=!0,r},Rl=`
  varying vec2 vUv;
...
`,Hl=()=>{let e=(0,r.useRef)(null),t=(0,r.useRef)(()=>{}),[n,i]=(0,r.useState)(null);return(0,r.useEffect)(()=>{let n=e.current;if(!n)return;let r=!1;n.replaceChildren();let a=new mn;a.background=new Z(`#020617`);let o=new Sa(42,1,.1,200),s=new cl({antialias:!0,alpha:!1});s.setClearColor(`#020617`,1),s.setPixelRatio(Math.min(window.devicePixelRatio||1,2)),s.domElement.style.display=`block`,s.domElement.style.width=`100%`,s.domElement.style.height=`100%`,s.domElement.style.cursor=`grab`,s.domElement.style.touchAction=`none`,s.domElement.dataset.autoRotate=`true`,n.appendChild(s.domElement);let c=new ma().load(`/earth.jpg`);c.colorSpace=Le;let l=Ll(),u=Cl().direction.clone(),d=new on;a.add(d);let f=new Fi(dl,96,96),p=new Wi({uniforms:{dayMap:{value:c},sunDirection:{value:u}},vertexShader:Rl,fragmentShader:zl}),m=new Xr(f,p);m.rotation.y=Math.PI,d.add(m);let h=new Fi(dl*1.025,96,96),g=new Wi({vertexShader:Bl,fragmentShader:Vl,blending:2,transparent:!0,depthWrite:!1,side:1}),_=new Xr(h,g);d.add(_);let v=new on;v.rotation.y=Math.PI,d.add(v);let y=new ci({color:`#a8edff`,transparent:!0,opacity:.52,depthWrite:!1}),b=new ci({color:`#ffffff`,transparent:!0,opacity:.52,depthWrite:!1}),x=null,S=null,C=null,w=()=>{if(!x||!C)return;let e=xl(x.zones),t=yl(x.segments,x.scale,t=>Sl(t,e));C.geometry.dispose(),C.geometry=t};fetch(`/timezone-boundaries.json`).then(e=>{if(!e.ok)throw Error(`Timezone boundaries unavailable`);return e.json()}).then(e=>{r||!e?.zones||!e?.segments||!e?.scale||(x=e,S=new bi(yl(e.segments,e.scale,()=>!0),y),C=new bi(new cr,b),S.renderOrder=1,C.renderOrder=2,v.add(S,C),w())}).catch(()=>void 0);let T=Il();a.add(T);let E=new on;a.add(E);let D=new Fi(.34,48,48),O=new Rr({color:`#ffe18a`}),k=new Xr(D,O);E.add(k);let A=new Or(new mr({map:l,color:`#ffd986`,blending:2,depthWrite:!1,transparent:!0}));A.scale.set(3.2,3.2,1),E.add(A);let j=()=>{let e=Cl();u.copy(e.direction),p.uniforms.sunDirection.value.copy(e.direction),E.position.copy(e.direction).multiplyScalar(18)};j();let ee=Math.atan2(u.x,u.z),M=Math.asin(ml(u.y,-.86,.86)),N={autoRotate:!0,dragging:!1,pointerMoved:!1,lastX:0,lastY:0,yaw:ee,pitch:M,distance:7,targetYaw:ee,targetPitch:M,targetDistance:7},te=()=>{N.autoRotate=!1,s.domElement.dataset.autoRotate=`false`},P=()=>{N.yaw+=(N.targetYaw-N.yaw)*.14,N.pitch+=(N.targetPitch-N.pitch)*.14,N.distance+=(N.targetDistance-N.distance)*.14;let e=Math.cos(N.pitch);o.position.set(N.distance*Math.sin(N.yaw)*e,N.distance*Math.sin(N.pitch),N.distance*Math.cos(N.yaw)*e),o.lookAt(0,0,0)},ne=()=>{let e=Math.max(1,Math.floor(n.clientWidth||n.offsetWidth||1)),t=Math.max(1,Math.floor(n.clientHeight||n.offsetHeight||1));o.aspect=e/t,o.updateProjectionMatrix(),s.setSize(e,t),P(),s.render(a,o)};ne();let re=new ResizeObserver(()=>ne());re.observe(n);let ie=window.requestAnimationFrame(()=>window.requestAnimationFrame(ne)),ae=new ci({color:`#ffd966`,transparent:!0,opacity:.95,depthWrite:!1}),F=new bi(new cr,ae);F.renderOrder=4,v.add(F);let oe=()=>{F.geometry.dispose(),F.geometry=new cr};t.current=oe;let se=new Va,I=new q,ce=e=>{let t=s.domElement.getBoundingClientRect();I.x=(e.clientX-t.left)/t.width*2-1,I.y=-((e.clientY-t.top)/t.height)*2+1,se.setFromCamera(I,o);let n=se.intersectObject(m).find(e=>e.point.dot(o.position)>0);if(!n){i(null),oe();return}if(!x)return;let{lat:r,lon:a}=wl(n.point),c=jl(r,a,x.segments,x.zones,x.scale);if(!c)return;let l=x.zones.indexOf(c),u=yl(x.segments,x.scale,e=>e.includes(l));F.geometry.dispose(),F.geometry=u,i(c)},L=[],le=e=>{if(te(),L.push({id:e.pointerId,x:e.clientX,y:e.clientY}),L.length===1)N.dragging=!0,N.pointerMoved=!1,N.lastX=e.clientX,N.lastY=e.clientY;else if(L.length===2){N.dragging=!1,N.pointerMoved=!0;let e=L[0].x-L[1].x,t=L[0].y-L[1].y;N.lastPinchDist=Math.hypot(e,t)}s.domElement.style.cursor=`grabbing`,s.domElement.setPointerCapture(e.pointerId)},ue=e=>{let t=L.findIndex(t=>t.id===e.pointerId);if(t!==-1&&(L[t].x=e.clientX,L[t].y=e.clientY),L.length===1&&N.dragging){let t=e.clientX-N.lastX,n=e.clientY-N.lastY;Math.abs(t)+Math.abs(n)>4&&(N.pointerMoved=!0),N.targetYaw-=t*.006,N.targetPitch=ml(N.targetPitch+n*.006,-1.15,1.15),N.lastX=e.clientX,N.lastY=e.clientY}else if(L.length===2){let e=L[0].x-L[1].x,t=L[0].y-L[1].y,n=Math.hypot(e,t);if(N.lastPinchDist){let e=N.lastPinchDist-n;N.targetDistance=ml(N.targetDistance+e*.02,4.2,12)}N.lastPinchDist=n}},de=e=>{let t=L.findIndex(t=>t.id===e.pointerId);t!==-1&&L.splice(t,1);let n=N.dragging&&!N.pointerMoved&&L.length===0;L.length===0?(N.dragging=!1,N.lastPinchDist=null,s.domElement.style.cursor=`grab`):L.length===1&&(N.dragging=!0,N.lastX=L[0].x,N.lastY=L[0].y,N.lastPinchDist=null),s.domElement.hasPointerCapture(e.pointerId)&&s.domElement.releasePointerCapture(e.pointerId),n&&ce(e)},fe=e=>{e.preventDefault(),te(),N.targetDistance=ml(N.targetDistance+e.deltaY*.005,4.2,12)};s.domElement.addEventListener(`pointerdown`,le),s.domElement.addEventListener(`pointermove`,ue),s.domElement.addEventListener(`pointerup`,de),s.domElement.addEventListener(`pointercancel`,de),s.domElement.addEventListener(`wheel`,fe,{passive:!1});let R=0,pe=0,me=e=>{N.autoRotate&&(N.targetYaw+=.0014),e-pe>6e4&&(j(),w(),pe=e),F.geometry.attributes.position?.count>0&&(ae.opacity=.65+.35*Math.sin(e*.0025)),P(),T.rotation.y+=18e-5,A.material.rotation+=.002,s.render(a,o),R=window.requestAnimationFrame(me)};return R=window.requestAnimationFrame(me),()=>{r=!0,window.cancelAnimationFrame(R),window.cancelAnimationFrame(ie),re.disconnect(),s.domElement.removeEventListener(`pointerdown`,le),s.domElement.removeEventListener(`pointermove`,ue),s.domElement.removeEventListener(`pointerup`,de),s.domElement.removeEventListener(`pointercancel`,de),s.domElement.removeEventListener(`wheel`,fe),t.current=()=>{},f.dispose(),p.dispose(),h.dispose(),g.dispose(),S&&S.geometry.dispose(),C&&C.geometry.dispose(),y.dispose(),b.dispose(),F.geometry.dispose(),ae.dispose(),T.geometry.dispose(),T.material.dispose(),D.dispose(),O.dispose(),A.material.dispose(),c.dispose(),l.dispose(),s.dispose(),s.domElement.remove()}},[]),(0,ll.jsxs)(`div`,{style:{position:`relative`,width:`100%`,height:`100%`,minHeight:`400px`,background:`#020617`,overflow:`hidden`},children:[(0,ll.jsx)(`div`,{ref:e,style:{width:`100%`,height:`100%`}}),n&&(0,ll.jsx)(Fl,{zone:n,onClose:()=>{t.current(),i(null)}},n)]})};export{Hl as default};